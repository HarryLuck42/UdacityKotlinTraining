...
package com.corp.luqman.kotlintraining.lesson3.fragments
...
import com.corp.luqman.kotlintraining.databinding.FragmentGameWonBinding
...
//        var args = arguments?.let { GameWonFragmentArgs.fromBundle(it) }
    ...
    private fun getSharedIntent() : Intent{
        ...
        val intentShare = Intent(ACTION_SEND)
