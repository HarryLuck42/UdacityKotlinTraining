...
package com.corp.luqman.kotlintraining.lesson9.ui
...
import com.corp.luqman.kotlintraining.databinding.DevbyteItemBinding
import com.corp.luqman.kotlintraining.databinding.FragmentDevByteBinding
import com.corp.luqman.kotlintraining.lesson9.domain.Video
import com.corp.luqman.kotlintraining.lesson9.viewmodels.DevByteViewModel
...
class DevByteFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.properties.observe(viewLifecycleOwner, Observer<List<Video>> { videos ->
            videos?.apply {
